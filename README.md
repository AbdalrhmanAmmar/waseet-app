...
- التوكن محفوظ في SecureStore على الهاتف. على الويب يُحفظ في الذاكرة فقط؛ إعادة تحميل الصفحة تستلزم تسجيل الدخول. إنشاء الطلب يتم مباشرة دون سلة؛ مسودته داخل الشاشة وتُمسح بالنجاح أو المغادرة المؤكدة أو الخروج.
...
- [تقرير إنشاء الطلب المباشر واللون](docs/order-create-design.ar.md)

- [تقرير الرئيسية الجديدة والرصيد والرسم البياني](docs/home-dashboard.ar.md)
