      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.customerCard}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <CustomText style={customerArea ? styles.areaPickerText : styles.areaPickerPlaceholder}>
              {customerArea
          ...
          >
            ...
            >
              <Icon
                ...
                size={hp(2.4)}
                color={payment === opt.id ? COLORS.mainOrange : COLORS.darkgray}
              />
            </View>
                  ...
                  >
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                      <Icon
                        ...
                        size={hp(2.2)}
                        color={isSelected ? COLORS.mainOrange : '#64748B'}
                      />
                      <CustomText
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                      ...
                      {isSelected && (
                        <Icon name="check-circle" size={hp(2.2)} color={COLORS.mainOrange} />
                      )}
                    </View>
                  </TouchableOpacity>
                );
